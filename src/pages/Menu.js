...
const foodItems = [
  {
    ...
    category: "Burgers",
    price: 450,
    img: process.env.PUBLIC_URL + "/images/zinger burger.jfif",
...

  {
    ...
    category: "Burgers",
    price: 850,
   img: process.env.PUBLIC_URL + "/images/Burger.jfif",
  ...
  },
  {
    ...
    category: "Burgers",
    price: 700,
    img: process.env.PUBLIC_URL + "/images/jalapeno.jfif",
...

  {
    ...
    category: "Burgers",
    price: 800,
    img: process.env.PUBLIC_URL + "/images/mushroom.jfif",
...

  {
    ...
    category: "Burgers",
    price: 500,
    img: process.env.PUBLIC_URL + "/images/tower.jfif",
...

  {
    ...
    category: "Burgers",
    price:  550,
    img: process.env.PUBLIC_URL + "/images/mighty.jfif",
...

  {
    ...
    category: "Shawarma",
    price:  400,
    img: process.env.PUBLIC_URL + "/images/shawarma.jfif",
...

  {
    ...
    category: "Shawarma",
    price: 550 ,
    img: process.env.PUBLIC_URL + "/images/cheesy.jfif",
  ...
  },
{
    ...
    category: "Shawarma",
    price:  600,
    img: process.env.PUBLIC_URL + "/images/mexican.jfif",
...

  {
    ...
    category: "Shawarma",
    price:  750,
   img: process.env.PUBLIC_URL + "/images/platter shawarma.jfif",
  ...
  
  {
    ...
    category: "Pizza",
    price:  1500,
    img: process.env.PUBLIC_URL + "/images/pepperoni.jfif",
...

  {
    ...
    category: "Pizza",
    price:  1500,
    img: process.env.PUBLIC_URL + "/images/fajita.jfif",
  ...
  },
{
  ...
  category: "Pizza",
  price:  1400,
  img: process.env.PUBLIC_URL + "/images/tikka.jfif",
...

{
  ...
  category: "Pizza",
  price: 1600,
  img: process.env.PUBLIC_URL + "/images/bbq.jfif",
...

{
  ...
  category: "Pizza",
  price: 1200,
  img: process.env.PUBLIC_URL + "/images/veggie.jfif",
...

{
  ...
  category: "Pizza",
  price:  1700,
  img: process.env.PUBLIC_URL + "/images/cheese lover.jfif",
...

  {
    ...
    category: "Fries",
    price: 600,
   img: process.env.PUBLIC_URL + "/images/loaded fries.jfif",
  ...
  category: "Fries",
  price: 300,
  img: process.env.PUBLIC_URL + "/images/masala.jfif",
...
},
{
  ...
  category: "Fries",
  price: 350,
  img: process.env.PUBLIC_URL + "/images/garlic.jfif",
...
},
{
  ...
  category: "Fries",
  price: 400,
  img: process.env.PUBLIC_URL + "/images/cheese.jfif",
...
},
{
  ...
  category: "Broast",
  price: 450,
  img: process.env.PUBLIC_URL + "/images/broast.jfif",
...
},
{
  ...
  category: "Broast",
  price: 450,
  img: process.env.PUBLIC_URL + "/images/spicy.jfif",
...
},
{
  ...
  category: "Broast",
  price: 450,
  img: process.env.PUBLIC_URL + "/images/garlic mayo.jfif",
...
},
{
  ...
  category: "Broast",
  price: 450,
  img: process.env.PUBLIC_URL + "/images/bbq broast.jfif",
...
},
{
  ...
  category: "Sandwich",
  price: 480,
  img: process.env.PUBLIC_URL + "/images/sandwich.jfif",
...
},
{
  ...
  category: "Sandwich",
  price: 550,
  img: process.env.PUBLIC_URL + "/images/grilled.jpg",
...
},
{
  ...
  category: "Sandwich",
  price: 550,
  img: process.env.PUBLIC_URL + "/images/smoky.jfif",
...
},
{
  ...
  category: "Sandwich",
  price: 650,
  img: process.env.PUBLIC_URL + "/images/spicy jalapeno.jfif",
...
},
{
  ...
  category: "Sandwich",
  price: 400,
  img: process.env.PUBLIC_URL + "/images/egg.jfif",
...
},
{
  ...
  category: "Wings",
  price: 500,
  img: process.env.PUBLIC_URL + "/images/hot.jfif",
...
},
{
  ...
  category: "Wings",
  price: 500,
  img: process.env.PUBLIC_URL + "/images/bbq wings.jfif",
...
},
{
  ...
  category: "Wings",
  price: 500,
  img: process.env.PUBLIC_URL + "/images/honey.jfif",
...
},
{
  ...
  category: "Rolls",
  price: 400,
  img: process.env.PUBLIC_URL + "/images/roll.jfif",
...
},
{
  ...
  category: "Rolls",
  price: 450,
  img: process.env.PUBLIC_URL + "/images/malai.jfif",
...
},
{
  ...
  category: "Rolls",
  price: 500,
  img: process.env.PUBLIC_URL + "/images/zinger roll.jfif",
...
},
{
  ...
  category: "Rolls",
  price: 450,
  img: process.env.PUBLIC_URL + "/images/spicy roll.jfif",
...
},
{
  ...
  category: "Steak",
  price: 850,
  img: process.env.PUBLIC_URL + "/images/steak.jfif",
...
},
{
  ...
  category: "Steak",
  price: 700,
  img: process.env.PUBLIC_URL + "/images/chicken steak.jpg",
...
},
{
  ...
  category: "Steak",
  price: 750,
  img: process.env.PUBLIC_URL + "/images/mushroom steak.jfif",
...
},
{
  ...
  category: "Peri Peri",
  price: 500,
  img: process.env.PUBLIC_URL + "/images/bites.jfif",
...
},
{
  ...
  category: "Peri Peri",
  price: 500,
  img: process.env.PUBLIC_URL + "/images/cheesy bites.jfif",
...
},
{
  ...
  category: "Pasta",
  price: 700,
  img: process.env.PUBLIC_URL + "/images/alfredo.jfif",
...
},
  {
    ...
    category: "Pasta",
    price: "Rs. 500",
    img: process.env.PUBLIC_URL + "/images/pasta.jfif",
  ...
  },
  {
    ...
    category: "Pasta",
    price: "Rs. 700",
    img: process.env.PUBLIC_URL + "/images/tarragon.jfif",
  ...
  },
  {
    ...
    category: "Pasta",
    price: "Rs. 650",
    img: process.env.PUBLIC_URL + "/images/mac.jfif",
   ...
   
  {
    ...
    category: "Tacos",
    price:  600,
    img: process.env.PUBLIC_URL + "/images/tacos.jfif",
  ...
  },
  {
    ...
    category: "Tacos",
    price:  750,
    img: process.env.PUBLIC_URL + "/images/beef tacos.jfif",
  ...
  },
  {
    ...
    category: "Desserts",
    price:  350,
    img: process.env.PUBLIC_URL + "/images/lava.jfif",
...

  {
    ...
    category: "Desserts",
    price:  300,
    iimg: process.env.PUBLIC_URL + "/images/cheesecake.jfif",
...

  {
    ...
    category: "Juices",
    price:  400,
    img: process.env.PUBLIC_URL + "/images/mint.jfif",
...

  {
    ...
    category: "Juices",
    price:  300,
    img: process.env.PUBLIC_URL + "/images/orange.jfif",
...

  {
    ...
    category: "Drinks",
    price: "Rs. 150",
    img: process.env.PUBLIC_URL + "/images/coca.jfif",
...

  {
    ...
    category: "Drinks",
   price: 200,
   img: process.env.PUBLIC_URL + "/images/soda.jfif",
    ...
    <div className="container py-5 mt-5">
      ...
      <div className="text-center mb-4">
        {categories.map((category) => (
          <button key={category}  className={`btn m-2 ${  selectedCategory === category ? "btn-danger"  : "btn-outline-danger" }`}
            onClick={() => setSelectedCategory(category)}> {category}
          </button> ))}
      </div>

      <div className="row">
        {filteredItems.map((item) => ( <div key={item.id} className="col-md-4 col-lg-3 mb-4"> <div className="card h-100 shadow-sm">
              <img src={item.img} alt={item.name}  className="card-img-top" style={{  height: "220px",  objectFit: "cover"}} />
              ...
              <div className="card-body">
                ...
                <div className="d-flex justify-content-between align-items-center">
                 ...
                 <button className="btn btn-warning add-cart-btn" onClick={() => addToCart(item)}>
                    Add To Cart
                  </button>
                </div>
              </div>
